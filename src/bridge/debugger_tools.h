...
// Registers twenty-four debugger tools: debugger_status,
...
// find_references, disassemble_function, execute_command, run_script and
// read_log. Each talks to the x64dbg plugin through link. Together with
// server_status, registered separately in tool_registry.cpp, the server
// exposes twenty-five tools to the model.
