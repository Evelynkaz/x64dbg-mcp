...
// Registers twenty-one debugger tools: debugger_status,
...
// find_references and disassemble_function. Each talks to the x64dbg
// plugin through link. Together with server_status, registered separately
// in tool_registry.cpp, the server exposes twenty-two tools to the model.
