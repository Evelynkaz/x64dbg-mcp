...
// Registers forty-eight debugger tools: debugger_status,
...
// set_page_rights, trace_until, trace_record, set_trace_log,
// run_to_user_code, code_coverage, list_symbols, annotate, list_handles,
// list_windows, list_connections, seh_chain, list_processes,
// attach_process, detach_process, allocate_memory, free_memory and
// dump_memory. Each talks to the x64dbg plugin through link. Together
// with server_status, registered separately in tool_registry.cpp, the
// server exposes forty-nine tools to the model.
